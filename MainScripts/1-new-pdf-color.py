...
for z in range(0, 2):
    for x in range(len(topic)):
        ...
        for i in range(0, numrep):
            ...
            charN = (random_string_generator(sizen, chars2)).upper()
            ...
            lines = ('| '.join(lines))
            print(lines)
            keysearched = "<p><strong>" + (str(lines)).upper() + "</strong></p>"
            print(lines)

            DATETIME = "<h3>" + ("UPDATED : " + d3 + " ( Online Users: " + onlineusers + ") ") + "=> [VERSION :" + (
                str(vers)) + "]</h3>"
            ...
            with open(b + "\\" + niche, encoding='utf-8') as f:
                ...
                MYDOMAINLINK = "<center><a href=" + '"' + LINKD + '"'">" + "<img src='https://lh3.googleusercontent.com/-qDE6qRDp84o/YdFIYF2yFcI/AAAAAAAABNM/j8-jXaCibyMIOrBVvT5Ah8jwieVUhXAQgCNcBGAsYHQ/h101/mainb.jpg'>" + "</a></center>"
                MAINTITLE = MAINTITLE + DATETIME +keysearched+ MYDOMAINLINK
            ...
            metacode = '<meta name="pdfkit-title" content="' + "{"+charN+"} "+ klist1.capitalize() +"-"+klist.capitalize()+ '"/>'
