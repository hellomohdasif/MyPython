...
outresult="E:\\connect\\\seltxt\\movie.txt"
if profile == "3":
...
def changeme():
    ...
    for x in range(0, len(topic)):
        ...
        full_path = 'E:\\connect\\\MYNEW\\movie\\movie'
        ...
        for i in range(0, numrep):
            ...
            with open(full_path + ".csv", 'r') as k:
                ...
                lines1 = [w.replace('MOVIENAME', MOVIENAME) for w in lines1]
                lines1 = [w.replace('\n', "") for w in lines1]
            ...
            LINKD = "https://bit.ly/3m1EI55"


            with open("E:\\connect\\\MYNEW\\movie\\movie.txt", encoding='utf-8') as f:
                ...
                if typepost == "html":
                    ...
                    MYDOMAINLINK = "<a href=" + LINKD + ">" + "Watch or Download Full Movie Here" + "</a></br>"
                    ...
                    MYDOMAINLINK = "`Watch or download full movie. <" + LINKD + ">`__\n\n" + "`Watch or download full movie. <" + LINKD + ">`__\n\n"
                    ...
                    # f = f.replace('DATETIME', DATETIME.upper())
                    # f = f.replace('MYDOMAINLINK', MYDOMAINLINK)
                    f = f.replace('MOVIENAME ',MOVIENAME)
                                ...
                                try:
                                    ...
                                    while flg:
                                        ...
                                        try:
                                            ...
                                            s71 = WebDriverWait(driver, 1000).until(
                                            ...
                                            s75.click()
                                            Thread.sleep(6)
                                            flink = (driver.find_element_by_xpath(
                                                '//*[@id="project_bar"]/div/div/a').get_attribute('href'))
